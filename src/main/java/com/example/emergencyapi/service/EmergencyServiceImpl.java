...
public class EmergencyServiceImpl implements EmergencyService {
    ...
    private final SugessionService sugessionService;

    public EmergencyServiceImpl(What3WordsClient what3WordsClient, SugessionService sugessionService) {
        this.what3WordsClient = what3WordsClient;
        this.sugessionService = sugessionService;
    }
